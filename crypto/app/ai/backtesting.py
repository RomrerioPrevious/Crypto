...
def backtest_bot(leverage, csv_backtesting, model_path):
    ...
    environment = TradingEnvironment(data=backtest_data, window_size=window_size,
    ...
    portfolio = PerformanceMetrics.calculate_returns(portfolio)
    portfolio = PerformanceMetrics.calculate_cumulative_returns(portfolio)
    sharpe_ratio = PerformanceMetrics.calculate_sharpe_ratio(portfolio)
    ...
    PerformanceMetrics.plot_cumulative_returns(portfolio)
